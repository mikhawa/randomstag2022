...
(function () {
    ...
    function O(h) {
        var m = ((h & 16711680) >> 16).toString(16), F = ((h & 65280) >> 8).toString(16);
    ...
    function I(h, m) {
        ...
        }[h || "solid"]) for (var r = 0; r < F.length; r++) F[r] *= m; else F = [];
        return F
    }
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ?
            ...
            }), La(h._menuButton), h._menuButton.title = h._cultureInfo.menuText) : wa(h._menuButton); else if (h.exportEnabled && v) {
            var m = !1;
        ...
        if (h.exportEnabled && h._dropdownMenu) {
        ...
        }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, {padding: "12px 8px 12px 8px"}), F.innerHTML = h._cultureInfo.printText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F),
            ...
            h.print();
            wa(h._dropdownMenu)
        }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, {padding: "12px 8px 12px 8px"}),
            ...
            wa(h._dropdownMenu)
        }, h.allDOMEventHandlers, !0), F = document.createElement("div"), V(F, {padding: "12px 8px 12px 8px"}), F.innerHTML = h._cultureInfo.savePNGText, F.style.backgroundColor = h.toolbar.itemBackgroundColor, F.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(F), J(F, "touchstart", function (h) {
            m = !0
        }, h.allDOMEventHandlers), J(F, "mousemove", function () {
    ...
    function Za(h, m, F) {
        ...
        m = !0;
        for (F = 0; 4 > F; F++) if (h[F] !== h[F + 4] | h[F] !== h[F + 8] | h[F] !== h[F + 12]) {
            m = !1;
            break
        }
        return m ?
    ...
    var Ha = !1, U = {}, v = !!document.createElement("canvas").getContext, ra = {
            Chart: {
                width: 500,
                height: 400,
                zoomEnabled: !1,
        ...
        Ka = {en: {}}, w = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    ...
    var ea = 20, A = 14, bb = {
        light1: Va, light2: ab, dark1: Fa, dark2: {
            ...
            title: {fontFamily: w, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5},
            subtitles: [{
                fontFamily: w,
                fontSize: A,
                fontColor: ga,
    ...
    (function () {
        ...
        U._fTWm = function (h) {
            if ("undefined" === typeof U.pro.sCH && !cb) try {
                var m = (new Date).getMonth() % 3, r, v, Y = h[U.fSDec("buy")];
    ...
    var gb = function () {
            ...
            return function (A, I, Q) {
                var P = Q ? Q.days : m, O = Q ? Q.months : v, J = Q ? Q.shortDays : r, K = Q ? Q.shortMonths : Y;
                Q = "";
                var U = !1;
                ...
                Q = U ? "getUTC" : "get";
                var V = A[Q + "Date"](), N = A[Q + "Day"](),
                    ba = A[Q + "Month"](), a = A[Q + "FullYear"](), d = A[Q + "Hours"](), c = A[Q + "Minutes"](),
                    b = A[Q + "Seconds"](), e = A[Q + "Milliseconds"](), f = U ? 0 : A.getTimezoneOffset();
            ...
            var v = 0 > h ? !0 : !1;
            v && (h *= -1);
            var Y = r ? r.decimalSeparator : ".", w = r ? r.digitGroupSeparator : ",", E = "";
            m = String(m);
            var E = 1, A = r = "", I = -1, Q = [], P = [], O = 0, J = 0, K = 0, U = !1,
                V = 0, A = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            m = null;
            for (var N = 0; A && N < A.length; N++) if (m = A[N], "." === m && 0 > I) I = N; else {
                if ("%" === m) E *= 100; else if ("\u2030" === m) {
                    E *= 1E3;
                    continue
            ...
            h = (m[1] + "").split("");
            E && "0" === E[0] && E.shift();
            for (U = A = N = J = I = 0; 0 < Q.length;) if (m = Q.pop(), "#" === m || "0" === m) if (I++, I === O) {
                var ba = E, E = [];
                if ("0" === m) for (m = O - J - (ba ? ba.length : 0); 0 < m;) ba.unshift("0"), m--;
                for (; 0 < ba.length;) r = ba.pop() + r, U++, 0 === U % A && (N === K && 0 < ba.length) && (r = w + r)
            } else 0 < E.length ? (r = E.pop() + r, J++, U++) : "0" === m && (r = "0" + r, J++, U++), 0 === U % A && (N === K && 0 < E.length) && (r = w + r); else "E" !== m[0] && "e" !==
        ...
        Ra = window.devicePixelRatio || 1, Na = 1, la = $a ? Ra / Na : 1,
        ...
        jb = cb && -1 === window[ja("mnb`uhno")].href.indexOf(ja("gheemd")), kb = {
    ...
    W.prototype.addTo = function (h, m, r, v) {
        ...
        w.hasOwnProperty(h) || w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[h] && (this.options[h] =
    ...
    W.prototype.updateOption = function (h) {
        ...
        var m = ra[this._defaultsKey], v = {}, w = this[h], A = this._themeOptionsKey,
            I = this._index;
    ...
    W.prototype.removeEventListener = function (h, m) {
        if (h && m && this._eventListeners[h]) for (var r = this._eventListeners[h], v = 0; v < r.length; v++) if (r[v].eventHandler === m) {
            r[v].splice(v, 1);
            break
        }
    };
    ...
    ka.prototype.render = function (h) {
        if (0 !== this.fontSize) {
            ...
            var v = 0, w = this.topPadding, A = null;
            ...
            for (r = 0; r < this._wrappedText.lines.length; r++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign) v = this.width - A.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) v = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) v = (this.width - (this.leftPadding + this.rightPadding)) / 2 - A.width / 2 + this.leftPadding;
    ...
    ka.prototype._getLineWithWidth = function (h, m, r) {
        ...
        var v = r = 0, w = h.length - 1, A = Infinity;
        for (this.ctx.font = this._getFontString(); v <= w;) {
            var A = Math.floor((v + w) / 2), E = h.substr(0, A + 1);
    ...
    ka.prototype._wrapText = function () {
        var h = new String(Ga(String(this.text))), m = [], r = this.ctx.font, v = 0, w = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) w = v = 0; else for (; 0 < h.length;) {
            ...
            m.push(E);
            var I = w, w = Math.max(w, E.width), v = v + E.height, h = Ga(h.slice(E.text.length, h.length));
    ...
    za.prototype.setLayout = function () {
        if (this.text) {
            var h = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = h.layoutManager.getFreeSpace(),
                v = m.x1, w = m.y1, A = 0, I = 0,
                E = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, K, J;
    ...
    w = Pa.Chart = function () {
        ...
        m.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                this._resetButton ? (V(this._resetButton, {
                    ...
                    a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, xa(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled =
                        !1);
        ...
        m.prototype._processMultiYPlotUnit = function (a) {
            if (a.dataSeriesIndexes &&
                ...
                var k = this.data[a.dataSeriesIndexes[C]], n = 0, p = !1, q = !1, g, t, h;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var s = this.data[a.dataSeriesIndexes[l]], C = 0, k = !1, n = !1, p = b = 0;
                ...
                for (C = 0; C < s.dataPoints.length; C++) if ("undefined" ===
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, C = 0; C < a.dataSeriesIndexes.length; C++) {
                        ...
                        (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                            ...
                            if ((g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) && g.length) for (var v = 0; v < g.length; v++) q = Math.floor((g[v] - n) / m), g[v] < d[q].min && (d[q].min = g[v]), g[v] > d[q].max && (d[q].max = g[v]); else r(g) || (q = Math.floor((g - n) / m), g < d[q].min && (d[q].min = g), g > d[q].max && (d[q].max = g))
                        }
                    }
                }
            }
            ...
            if (f) {
                ...
                for (l = 0; l < this._axes.length; l++) if (this._axes[l].dataInfo._dataRanges) {
                    ...
                    for (s = 0; s < k.length - 1; s++) if (n = k[s].max, isFinite(n)) for (; s < k.length - 1;) if (C = k[s + 1].min, isFinite(C)) {
                        p = C - n;
        ...
        m.prototype.getObjectAtXY = function (a, d, c) {
            var b = null;
            if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (v) b = Za(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        m.prototype.renderIndexLabels = function (a) {
            var d = a || this.plotArea.ctx, c = this.plotArea,
                b = 0, e = 0, f = 0, l = f = e = 0, s = 0, C = b = 0, k = 0;
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var L = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries),
                    ...
                    x = {percent: null, total: null}, B = null;
                ...
                if (null !== D && "" !== D) {
                    var x = ma("indexLabelPlacement", n.dataPoint, n.dataSeries),
                        ...
                        z = ma("indexLabelTextAlign", n.dataPoint, n.dataSeries), w = n.direction,
                        e = n.dataSeries.axisX, f = n.dataSeries.axisY, E = !1, h = new ka(d, {
                            x: 0,
                            y: 0,
        ...
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var C = a.dataSeriesIndexes[s], k = this.data[C];
        ...
        m.prototype.renderStepLine = function (a) {
            var d =
                a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx;
                c.save();
                var e = this.plotArea;
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, l, s, C,
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < t.length) for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++) if (t[f].getTime ? C = t[f].x.getTime() :
        ...
        m.prototype.renderStackedColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints;
                    if (0 < u.length) {
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx :
                d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], l = [], s = [], C = [], k = 0, n, p,
                    q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0;
                var g = a.axisX.dataInfo.minDiff;
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    var h = a.dataSeriesIndexes[t], r = this.data[h], u = r.dataPoints;
                    if (0 < u.length) for (var m = 5 < g && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                        n = a.axisX.convertValueToPixel(b);
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < t.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < t.length; f++) if (t[f].getTime ? C = t[f].x.getTime() : C = t[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < u.length) {
                        ...
                        typeof u[k].y) {
                            ...
                            var x = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = x + g << 0, D;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) s[b] = u[k].y + (s[b] ? s[b] : 0), 0 < s[b] && (D = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(s[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = u[k].y + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = D = a.axisY.convertValueToPixel(C[b]); else if (n = a.axisY.convertValueToPixel(u[k].y),
                            0 <= u[k].y) {
                                var z = f[b] ? f[b] : 0;
                                D = q + z;
                                n += z;
        ...
        m.prototype.renderStackedBar100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b =
                        null, e = this.plotArea, f = [], l = [], s = [], C = [], k = 0, n, p,
                    q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                    k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0;
                var g = a.axisX.dataInfo.minDiff;
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++) if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            var B = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, D = B + g << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                s[b] = x + (s[b] ? s[b] : 0);
                                if (0 >= s[b]) continue;
                                x = f[b] ? f[b] : q;
                                f[b] = n = a.axisY.convertValueToPixel(s[b])
                            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) C[b] = x + (C[b] ? C[b] : 0), n = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(C[b]); else if (n = a.axisY.convertValueToPixel(x), 0 <= u[k].y) {
                                var z =
                                    f[b] ? f[b] : 0;
                                x = q + z;
                                n += z;
        ...
        m.prototype.renderArea =
            function (a) {
                ...
                var e = a.targetCanvasCtx || this.plotArea.ctx, f = v ? this._preRenderCtx :
                    e;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var l = this._eventManager.ghostCtx, s = a.axisY.lineCoordinates, C = [], k = this.plotArea, n;
                    f.save();
                    v && l.save();
                    f.beginPath();
                    ...
                    for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                        var q = a.dataSeriesIndexes[p], g = this.data[q], t = g.dataPoints, C = g.id;
                        ...
                        var h = 0, r, u, m, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                            a.axisY.viewportMinimum : 0), B, D = null;
                        if (0 < t.length) {
                            var z = g._colorSet[h % g._colorSet.length], w = g.lineColor = g.options.lineColor || z,
                                E = w;
                            f.fillStyle = z;
                            f.strokeStyle = w;
                            ...
                            for (var fa = !0; h < t.length; h++) if (m = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !fa))) if ("number" !==
            ...
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), v && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle && (b.strokeStyle =
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    var l = [], q = 0, g, t,
                        ...
                        y = [];
                    if (0 < p.length) {
                        var x = n._colorSet[q % n._colorSet.length], B = n.lineColor = n.options.lineColor || x, D = B;
                        b.fillStyle = x;
                        b.strokeStyle = B;
                        b.lineWidth = n.lineThickness;
                        var z = "solid";
                        if (b.setLineDash) {
                            var E = I(n.nullDataLineDashType, n.lineThickness), z = n.lineDashType,
        ...
        m.prototype.renderStepArea = function (a) {
            ...
            var e = a.targetCanvasCtx ||
                this.plotArea.ctx, f = v ? this._preRenderCtx : e;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    d = !0;
                    var r = 0, m, u, y,
                        x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), B, D = null;
                    c = !1;
                    if (0 < t.length) {
                        var z = g._colorSet[r % g._colorSet.length], w = g.lineColor = g.options.lineColor || z, E = w;
                        f.fillStyle = z;
                        f.strokeStyle = w;
                        f.lineWidth = g.lineThickness;
                        var T = "solid";
                        if (f.setLineDash) {
                            var S = I(g.nullDataLineDashType, g.lineThickness), T = g.lineDashType,
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var D = a.dataSeriesIndexes[B], z = this.data[D], w = z.dataPoints;
                    z.dataPointIndexes = [];
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    m.fillStyle = q;
                    if (0 < n.length) {
                        var e = z._colorSet[0], E = z.lineColor = z.options.lineColor || e, T = E;
                        b.fillStyle = e;
                        b.strokeStyle = E;
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof ia.y) z.connectNullData || (aa || y) || d(), aa = !0; else {
                                ...
                                0 == q % 250 && (d(), b.moveTo(g, t), v && m.moveTo(g, t), k.push({x: g, y: r - oa})));
                                u = {x: g, y: t};
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    k = [];
                    if (0 < n.length) {
                        var e = z._colorSet[q % z._colorSet.length], E = z.lineColor = z.options.lineColor || e, T = E;
                        b.fillStyle = e;
                        b.strokeStyle = E;
                        b.lineWidth = z.lineThickness;
                        u = "solid";
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q], ia = null,
                                ia = 0 <= z.dataPointIndexes[f] ? w[z.dataPointIndexes[f]] : {x: f, y: null};
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa))) if ("number" !== typeof ia.y) z.connectNullData || (aa || m) || d(), aa = !0; else {
                                var oa;
        ...
        m.prototype.renderBubble = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++) for (var n = a.dataSeriesIndexes[k], p = this.data[n], q = p.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" ===
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++) if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                        var L = a.dataSeriesIndexes[m], u = this.data[L], y = u.dataPoints;
                        if (0 < y.length) for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++) if (y[s].getTime ? g = y[s].x.getTime() : g = y[s].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(y[s].y) && y[s].y.length && "number" === typeof y[s].y[0] && "number" === typeof y[s].y[1] && "number" === typeof y[s].y[2] && "number" === typeof y[s].y[3]) {
                            ...
                            var B = h - t / 2 << 0, D = B + t << 0,
                                f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                                e = y[s].color ? y[s].color : u._colorSet[0], z = Math.round(Math.max(1, 0.15 * t)),
                                w = 0 === z % 2 ? 0 : 0.5, E = u.dataPointIds[s];
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, L = 0; L < a.dataSeriesIndexes.length; L++) {
                    var u = a.dataSeriesIndexes[L], y = this.data[u], x = y.dataPoints;
                    if (0 < x.length) for (var B = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                    !r(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3] && "number" === typeof x[l].y[4] && 5 === x[l].y.length) {
                        ...
                        var D = s - t / 2 << 0, z = s + t / 2 << 0, e = x[l].color ? x[l].color : y._colorSet[0],
                            w = Math.round(Math.max(1,
                                0.15 * t)), E = 0 === w % 2 ? 0 : 0.5,
                            ...
                            t / 100 > t ? t : parseInt(aa) * t / 100 : t, ia = 1 === Math.round(S) % 2 ? 0.5 : 0,
                            ...
                            M = 1 === Math.round(J) % 2 ? 0.5 : 0, P = y.upperBoxColor, U = y.lowerBoxColor,
                            ua = r(y.options.fillOpacity) ? 1 : y.fillOpacity, R = y.dataPointIds[l];
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y], B = this.data[x], D = B.dataPoints,
                        z = r(B._linkedSeries) ? !1 : B._linkedSeries.type.match(/(bar|column)/ig) && B._linkedSeries.visible ? !0 : !1,
                        w = 0;
                    if (z) for (e = B._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible ||
                    ...
                    u > s && (u =
                        s);
                    if (0 < D.length) for (var E = B._colorSet, s = 0; s < D.length; s++) {
                        ...
                        var S = {
                            ...
                            dashType: D[s].stemDashType ? D[s].stemDashType :
                                B.stemDashType
                        };
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < p.length) {
                        var x = n._colorSet[g % n._colorSet.length], B = n.lineColor = n.options.lineColor || x, w = B;
                        b.fillStyle = x;
                        b.strokeStyle = B;
                        b.lineWidth = n.lineThickness;
                        var z = "solid";
                        if (b.setLineDash) {
                            var E = I(n.nullDataLineDashType,
                                n.lineThickness), z = n.lineDashType, A = I(z, n.lineThickness);
                            b.setLineDash(A)
                        }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var B = "solid", D;
                        if (b.setLineDash) {
                            var z = I(k.nullDataLineDashType, k.lineThickness), B = k.lineDashType;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    var u = "number" === typeof r.options.lineThickness ? Math.round(r.lineThickness) : 1,
                        y = 1 === Math.round(u) %
                        2 ? -0.5 : 0;
                    if (0 < m.length) for (var x = 5 < q && r.bevelEnabled ? !0 : !1, B = !1, w = null, z = null, l = 0; l < m.length; l++) if (m[l].getTime ? n = m[l].x.getTime() : n = m[l].x, "number" !== typeof m[l].y) {
        ...
        m.prototype.renderPie = function (a) {
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    } else for (a = 0; a < n.length; a++) h = g[a], v = "pie" === k.type ? 0.7 * z : 0.8 * z, u = x.x + v * Math.cos(h.midAngle), r = x.y + v * Math.sin(h.midAngle), h.indexLabelTextBlock.x = u, h.indexLabelTextBlock.y = r;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var k = this.data[a.dataSeriesIndexes[0]], n = k.dataPoints, p = 10, q = this.plotArea,
                    g = k.dataPointEOs, t = 2, v, w = 1.3, u = 20 / 180 * Math.PI, y = 6,
                    x = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, B = 0;
                a = !1;
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function e() {
                ...
                if (e) for (l = H.length - 1; 0 <= l; l--) a = R[l], H[l].textBlock.maxWidth =
            ...
            function w(a) {
                ...
                if (L.subtitles) for (var b = 0; b < L.subtitles.length; b++) {
                    var c = L.subtitles[b];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var S = x.x1 + D, J = x.x2 - D, K = x.y1 + B, Q = x.y2 - B,
                ...
                if (0 != u.length && (u.dataPoints &&
                    ...
                    var D = S + a / 2, V = S, $ = S + a, pa = u.reversed ? Q : K, M = D - G / 2, ba = D + G / 2,
                        Y = u.reversed ? K + O : Q - O,
                        ua = u.reversed ? K : Q;
                    a = [];
                    var D = [], R = [], A = [], W = K, da, ca = (Y - pa) / (M - V), ga = -ca,
                        S = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== S) {
                        if (u.reversed) for (A.push(W), G = S.length - 1; 0 < G; G--) W += S[G], A.push(W); else for (G = 0; G < S.length; G++) W += S[G], A.push(W);
                        if (u.reversed) for (G = 0; G < S.length; G++) A[G] < Y ? (a.push(M), D.push(ba), da = G) : (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga)); else for (G = 0; G < S.length; G++) A[G] < Y ? (a.push((A[G] - pa + ca * V) / ca), D.push((A[G] - pa + ga * $) / ga), da = G) : (a.push(M), D.push(ba));
                        ...
                        if (!F) for (G = 0; G < y.length; G++) z = u.dataPointIds[G], a = {
                            id: z,
                            objectType: "dataPoint",
                            dataPointIndex: G,
                            dataSeriesIndex: 0,
            ...
            for (var h = 0, r = 0; r < l.length; r++) {
                for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
                    ...
                    if ("error" === q.chartType) {
                        ...
                        this.ctx.beginPath();
                        var w = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = m + 0.15 * this.lineHeight,
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "splineArea":
                            case "scatter":
                                var v = ma("markerSize", g, this) || 4, w = c ? 20 : v,
        ...
        E.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks &&
                q[g].scaleBreaks._appliedBreaks.length) for (var t = q[g].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > q[g].viewportMaximum); v++) t[v].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = v), t[v].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = v));
            ...
            if ("normal" === e) {
                ...
                v;) {
                    var G = 0, Q = 0, U = 0, X = 0, V = e = 0, M = 0, Z = 0, W = 0, Y = 0, R = 0, $ = 0;
                    if (c && 0 < c.length) for (B = [], g = R = 0; g < c.length; g++) B.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), R += B[g], M += c[g] && !n.isNavigator ? c[g].margin : 0; else B.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    O.push(B);
                    if (b && 0 < b.length) for (D = [], g = $ = 0; g < b.length; g++) D.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), $ += D[g], Z += b[g] ? b[g].margin : 0; else D.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                    P.push(D);
                    l = Math.round(f.x1 + R + M);
                    m = Math.round(f.x2 - $ - Z > n.width - p ? n.width - p : f.x2 - $ - Z);
                    if (a && 0 < a.length) for (y = [], g = W = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates = {}), a[g].lineCoordinates.width = Math.abs(m - l), a[g].title && (a[g]._titleTextBlock.maxWidth = 0 < a[g].titleMaxWidth && a[g].titleMaxWidth < a[g].lineCoordinates.width ? a[g].titleMaxWidth : a[g].lineCoordinates.width), y.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateHeight() : 0)), W += y[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else y.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
                        0));
                    K.push(y);
                    if (d && 0 < d.length) for (x = [], g = Y = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(m - l), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth < d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), x.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), Y += x[g], V += d[g] && !n.isNavigator ? d[g].margin : 0; else x.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(x);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + R + M), d[g].lineCoordinates.x2 =
                    ...
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), M = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + Y + V < Math.max(M, p) ? Math.max(M, p) : f.y1 + Y + V), M = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (W + e + M)), b[g].lineCoordinates =
                        {
                            x1: l + X,
                            y1: h,
                            x2: l + X,
                    ...
                    if (0 < v) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = K[v - 1][g] === K[v][g] ? !0 : !1; else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) F = N[v - 1][g] === N[v][g] ? !0 : !1; else F = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) I = O[v - 1][g] === O[v][g] ? !0 : !1; else I = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = P[v -
                ...
                for (N = []; 4 > v;) {
                    ...
                    if (a && 0 < a.length) for (A = [], g = X = 0; g < a.length; g++) A.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), X += A[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else A.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    K.push(A);
                    if (d && 0 < d.length) for (w = [], g = W = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), W += w[g], V += d[g] ? d[g].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
                        0));
                    N.push(w);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - W - V > n.width - 10 ? n.width - 10 : f.x2 - W - V), c[g].labelAutoFit && !r(y) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
                    c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V), b[g] && b[g].labelAutoFit && !r(B) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, B) : 0 === b[g].labelAngle ? Math.max(l, B / 2) : l), 0 < !d.length && (m -= D / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
                        0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
                    if (c && 0 < c.length) for (p = [], g = U = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), U += p[g] + c[g].margin, M += c[g].margin; else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(p);
                    if (b && 0 < b.length) for (z = [], g = Q = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), Q += z[g], Z += b[g].margin; else z.push(Math.ceil(b[0] ?
                    ...
                    if (c && 0 < c.length) for (g = c.length - 1; 0 <= g; g--) h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + Y), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + Y), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
                    ...
                    if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
                        ...
                        if (c && 0 < c.length) for (M = 0; M < c.length; M++) c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l =
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
                        ...
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2 - U) : f.y2 > n.height - Math.max(M, 10) ? n.height - Math.max(M, 10) : f.y2;
                        if (c && 0 < c.length) for (M = 0; M < c.length; M++) c[M] && c[M].labelAutoFit && (m = 0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m, l = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? m - W : l);
                    ...
                    if (0 < v) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = K[v - 1][g] === K[v][g] ? !0 : !1; else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) F = N[v - 1][g] === N[v][g] ? !0 :
                            !1; else F = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) I = E[v - 1][g] === E[v][g] ? !0 : !1; else I = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = u[v - 1][g] === u[v][g] ? !0 : !1; else J = !0
                    }
                    if (t && F && I && J) break;
                    v++
                }
        ...
        ca.prototype.render = function (a, d, c) {
            var b, e, f, h, m = null, v = null, k = null, n = "";
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    A = 0;
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var w = Math.abs(a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (var y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u =
                        ...
                        Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = x = u = 0, t = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else x += n[t].dataPoint.y, B = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x, B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B]), u = Math.abs(a - this.parent.convertValueToPixel(B)), u < w && (w = u, A = t); else for (w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     t = A = u = 0; t < n.length; t++) if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                    y = n[A];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t +=
                            n) if (this.parent.labels[t]) B = !0; else {
                            B = !1;
                            break
                        }
                        if (B) {
                    ...
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval),
                                                     t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) B = !0; else {
                        B = !1;
                        break
                    }
                    if (B) {
                        if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({x: a}), w = null, A = 0; A < this.parent.dataSeries.length; A++) (w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: y.dataPoint.x
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type ||
                        ...
                        Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])), u < w && (w = u, A = t); else u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y)), u < w && (w = u, A = t);
                    y = n[A];
                    b = 0;
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
                    ...
                    B = !1;
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) B = !0; else {
                        B = !1;
                        break
                    }
                    if (B) {
                    ...
                    B = !1;
                    n = "";
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += n) if (this.parent.labels[t]) B =
                        !0; else {
                        B = !1;
                        break
                    }
        ...
        $.prototype._updateToolTip = function (a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    var m =
                        [];
                    if (this.chart.axisX) for (var w = 0; w < this.chart.axisX.length; w++) {
                        for (var h = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[w].convertPixelToValue({y: d}) : this.chart.axisX[w].convertPixelToValue({x: a}), k = null, b = 0; b < this.chart.axisX[w].dataSeries.length; b++) (k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[w].dataSeries[b], null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
                        k = null
                    }
                    if (this.chart.axisX2) for (w = 0; w < this.chart.axisX2.length; w++) {
                        h =
                            "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[w].convertPixelToValue({y: d}) : this.chart.axisX2[w].convertPixelToValue({x: a});
                        k = null;
                    ...
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index; else if (v) if (b = Za(a, d, this.chart._eventManager.ghostCtx), 0 < b && "undefined" !== typeof this.chart._eventManager.objectMap[b]) {
        ...
        $.prototype.showAtX = function (a, d) {
            ...
            if (0 < f.length) {
                ...
                if (null !== h) {
                    ...
                    if (this.isToolTipDefinedInData && r(this.options.content) && r(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName("span"), h = 0; h < b.length; h++) b[h] && (b[h].style.color =
